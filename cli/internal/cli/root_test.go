...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	// Hand-adapted after renaming the generated Canvas endpoint-mirror group
	// from "courses" to "canvas" (it collided with the hand-written
	// CourseTable "courses" command group) and merging the top-level
	// "files <id>" command into "canvas files get --file <id>".
	expected := []string{
		"canvas",
		"canvas assignments",
