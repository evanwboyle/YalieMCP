...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"yalie-pp-cli auth login",
		"yalie-pp-cli doctor",
		"yalie-pp-cli help items",
		"yalie-pp-cli sync",
		"yalie-pp-cli profile list",
		"yalie-pp-cli feedback list",
		"yalie-pp-cli which",
		"yalie-pp-cli agent-context",
		"yalie-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"yalie-pp-cli teach",
		"yalie-pp-cli recall",
		"yalie-pp-cli learnings",
		"yalie-pp-cli teach-pattern",
		"yalie-pp-cli teach-lookup",
		"yalie-pp-cli items list",
	}
