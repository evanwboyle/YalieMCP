...
var whichIndex = []whichEntry{
	{Command: "audit recommend", Description: "See which of your remaining degree requirements have the best-rated available courses, without cross-checking two tools by hand.", Group: "Local state that compounds", WhyItMatters: "Reach for this instead of chaining 'audit get' and 'courses search' by hand when the agent's task is picking a course toward a specific unmet requirement."},
	{Command: "worksheet conflicts", Description: "Flags real time overlaps between courses already saved in a worksheet, before you find out the hard way.", Group: "Local state that compounds", WhyItMatters: "Use this whenever the task is validating a saved worksheet is schedulable, not just whether individual courses exist."},
	{Command: "worksheet syllabus-search", Description: "Search for a keyword or policy (e.g. 'no laptops', 'final exam') across every syllabus already fetched for your worksheet courses at once.", Group: "Local state that compounds", WhyItMatters: "Use this over repeated single-course 'courses syllabus' calls when the task spans a whole worksheet."},
	{Command: "majors fit", Description: "Check how much of a major's requirements your existing course history already satisfies, without declaring it.", Group: "Local state that compounds", WhyItMatters: "Use this over 'majors requirements' whenever the task is personalized completion, not general requirement browsing."},
	{Command: "certificates fit", Description: "Check how much of a certificate program's requirements your existing course history already satisfies, without declaring it.", Group: "Local state that compounds", WhyItMatters: "Use this over 'certificates list' whenever the task is personalized completion for a specific certificate, not general browsing."},
	{Command: "canvas files list", Description: "Browse a Canvas course's file directory (names, sizes, folders) without downloading anything — pick what's worth fetching before you fetch it.", Group: "Agent-native plumbing", WhyItMatters: "Always list before fetching a Canvas file — never bulk-download a course's Files section."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  yalie-pp-cli which "stale tickets"
  yalie-pp-cli which "bottleneck"
  yalie-pp-cli which --limit 1 "send message"
  yalie-pp-cli which                                # list the full capability index`,
