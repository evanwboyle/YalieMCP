...
// In production the landing page is a static React build served from public/;
// this route only answers in local dev, where we just point at the live site.
app.get("/", (_req, res) => res.redirect("https://yalie-mcp.vercel.app/"));
